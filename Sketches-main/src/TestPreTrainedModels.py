...
from torchvision.models import resnet18, ResNet18_Weights, resnet50, ResNet50_Weights, mobilenet_v2, \
    MobileNet_V2_Weights, mobilenet_v3_large, MobileNet_V3_Large_Weights
...
def ModelsQuantRoundErr(
        modelStrs=[],
        vec2quantLen: INF_INT = None,
        # Maximum number of elements in the output vector (clamping). If None, all weights are kept.
):
    """
    ...
    for modelStr in modelStrs:
        ...
        match modelStr:
            ...
            case _:
                print(
                    'In TestQauntModels.ModelsQuantRoundErr(). Sorry, the model {modelStr} you choose is not support yet.')
